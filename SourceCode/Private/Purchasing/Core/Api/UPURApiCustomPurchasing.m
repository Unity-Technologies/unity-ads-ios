...
+ (void)WebViewExposed_refreshCatalog: (USRVWebViewCallback *)callback {
    ...
    if (delegate) {
        @try {
            ...
            [callback error: NSStringFromUPURPurchasingError(UPURPurchasingErrorRetrieveProductsError)
                       arg1: nil, exception];
        }
    } else {
        [callback error: NSStringFromUPURPurchasingError(UPURPurchasingErrorRetrieveProductsError)
...
+ (void)WebViewExposed_purchaseItem: (NSString *)productId withExtras: (NSDictionary *)extras withCallBack: (USRVWebViewCallback *)callback {
    ...
    if (adapter) {
        ...
        [callback error: NSStringFromUPURPurchasingError(UPURPurchasingErrorPurchasingAdapterNull)
                   arg1: nil];
    }
} /* WebViewExposed_purchaseItem */
