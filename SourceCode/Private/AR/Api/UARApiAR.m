...
+ (void)WebViewExposed_getSupportedVideoFormats: (NSString *)configName callback: (USRVWebViewCallback *)callback {
    ...
    [callback invoke: (formats != nil) ?
     formats : [NSNull null], nil];
}
...
+ (void)WebViewExposed_restartSession: (NSDictionary *)properties callback: (USRVWebViewCallback *)callback {
    ...
    if (arView && arView.arSession) {
        ...
        if (configuration) {
            ...
            [callback error: @"Error creating configuration"
                       arg1: nil];
            return;
        }
        ...
        [callback error: @"Error restarting session - No active ARView"
                   arg1: nil];
    }
} /* WebViewExposed_restartSession */
...
+ (void)WebViewExposed_setDepthFar: (NSNumber *)far
    ...
    if (arView) {
        ...
        [callback error: @"Error setting far plane."
                   arg1: nil];
    }
}
...
+ (void)WebViewExposed_setDepthNear: (NSNumber *)near
    ...
    if (arView) {
        ...
        [callback error: @"Error setting near plane."
                   arg1: nil];
    }
}
...
+ (void)WebViewExposed_addAnchor: (NSString *)identifier
    ...
    if (arView && arView.arSession) {
        [arView addAnchor: identifier
            withTransform: matrix];
        [callback invoke: nil];
    } else {
        [callback error: @"Error adding anchor."
                   arg1: nil];
    }
}
...
+ (void)WebViewExposed_removeAnchor: (NSString *)identifier
    ...
    if (arView && arView.arSession) {
        ...
        [callback error: @"Error removing anchor."
                   arg1: nil];
    }
}
...
+ (void)WebViewExposed_advanceFrame: (USRVWebViewCallback *)callback {
    ...
    if (arView && arView.arSession) {
        ...
        [callback error: @"Error during advanceFrame."
                   arg1: nil];
    }
}
...
+ (void)WebViewExposed_getFrameInfo: (USRVWebViewCallback *)callback {
    ...
    if (!arView || !arView.arSession) {
        [callback error: @"No ARView or no session"
                   arg1: nil];
        return;
    }
    ...
    CGAffineTransform t = [UADSARUtils arFrame: arFrame
                displayTransformForOrientation: interfaceOrientation
                                      viewSize: [UADSARUtils                       sizeForOrientation: interfaceOrientation
                                                                                                width: videoWidth
                                                                                               height: videoHeight]];
#else
...
+ (void)WebViewExposed_setFrameScaling: (NSDictionary *)frameScale
    ...
    if ([frameScale objectForKey: @"scaleX"] && [frameScale objectForKey: @"scaleY"]) {
        @try {
            ...
            [callback error: @"Error setting frame scaling"
                       arg1: nil];
            return;
        }
    }
    ...
    [callback invoke: nil];
} /* WebViewExposed_setFrameScaling */
