...
+ (void)setInteger: (int)value forKey: (NSString *)key {
    [[NSUserDefaults standardUserDefaults] setInteger: [[NSNumber numberWithInt: value] integerValue]
                                               forKey: key];
    [[NSUserDefaults standardUserDefaults] synchronize];
}

+ (void)setFloat: (float)value forKey: (NSString *)key {
    [[NSUserDefaults standardUserDefaults] setFloat: [[NSNumber numberWithFloat: value] floatValue]
                                             forKey: key];
    [[NSUserDefaults standardUserDefaults] synchronize];
}

+ (void)setBoolean: (BOOL)value forKey: (NSString *)key {
    [[NSUserDefaults standardUserDefaults] setInteger: [[NSNumber numberWithBool: value] boolValue]
                                               forKey: key];
    [[NSUserDefaults standardUserDefaults] synchronize];
}

+ (void)setLong: (long)value forKey: (NSString *)key {
    [[NSUserDefaults standardUserDefaults] setObject: [NSNumber numberWithLong: value]
                                              forKey: key];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
