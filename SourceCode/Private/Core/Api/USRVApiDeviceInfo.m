...
+ (void)WebViewExposed_getSensorList: (USRVWebViewCallback *)callback {
    ...
    if (sensorList) {
        ...
        [callback error: USRVNSStringFromDeviceError(kUnityServicesCouldntGetSensorInfo)
                   arg1: nil];
    }
}
...
+ (void)WebViewExposed_getProcessInfo: (USRVWebViewCallback *)callback {
    ...
    if (processInfo) {
        ...
        [callback error: USRVNSStringFromDeviceError(kUnityServicesCouldntGetProcessInfo)
                   arg1: nil];
    }
}
