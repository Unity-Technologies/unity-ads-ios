...
+ (void)WebViewExposed_getString: (NSString *)key callback: (USRVWebViewCallback *)callback {
    ...
    if (preferenceValue != nil) {
        ...
        [callback error: USRVNSStringFromPreferencesError(kUnityServicesPreferencesCouldntGetValue)
                   arg1: nil];
    }
}
