...
+ (void)WebViewExposed_createPlacementContent: (NSString *)placementId withParams: (NSDictionary *)params withCallBack: (USRVWebViewCallback *)callback {
    UMONPlacementContent *placementContent = [UMONPlacementContentFactory create: placementId
                                                                      withParams   : [params mutableCopy]];

    [UMONPlacementContents putPlacementContent: placementId
                          withPlacementContent: placementContent];
    [callback invoke: nil];
}
...
+ (void)WebViewExposed_setPlacementContentState: (NSString *)placementId withState: (NSString *)state withCallBack: (USRVWebViewCallback *)callback {
    [UMONPlacementContents setPlacementContentState: placementId
                          withPlacementContentState: PlacementContentStateFromNSString(state)];
    [callback invoke: nil];
}
...
+ (void)WebViewExposed_sendAdFinished: (NSString *)placementId withFinishState: (NSString *)finishState withCallBack: (USRVWebViewCallback *)callback {
    [[UMONShowAdDelegateManager sharedInstance] sendAdFinished: placementId
                                               withFinishState: UMONUnityAdsFinishStateFromNSString(finishState)];
    [callback invoke: nil];
}
