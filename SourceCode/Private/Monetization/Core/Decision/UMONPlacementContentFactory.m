...
+ (UMONPlacementContent *)create: (NSString *)placementId withParams: (NSMutableDictionary *)params {
    ...
    switch (type) {
        case kPlacementContentTypeShowAd:
            return [[UMONShowAdPlacementContent alloc] initWithPlacementId: placementId
                                                                withParams: params];

        case kPlacementContentTypePromoAd:
            return [[UMONPromoAdPlacementContent alloc] initWithPlacementId: placementId
                                                                 withParams: params];

        case kPlacementContentTypeNoFill:
            return [[UMONNoFillPlacementContent alloc] initWithPlacementId: placementId
                                                                withParams: params];

        case kPlacementContentTypeCustom:
        default:
            return [[UMONPlacementContent alloc] initWithPlacementId: placementId
                                                          withParams: params];
    }
} /* create */
