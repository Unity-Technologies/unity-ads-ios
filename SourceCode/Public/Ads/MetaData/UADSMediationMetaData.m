...
- (void)setName: (NSString *)mediationNetworkName {
    [self set: @"name"
        value : mediationNetworkName];
}

- (void)setVersion: (NSString *)mediationSdkVersion {
    [self set: @"version"
        value : mediationSdkVersion];
}

- (void)setOrdinal: (int)mediationOrdinal {
    [self set: @"ordinal"
        value : [NSNumber numberWithInt: mediationOrdinal]];
}

- (void)setMissedImpressionOrdinal: (int)missedImpressionOrdinal {
    [self set: @"missedImpressionOrdinal"
        value : [NSNumber numberWithInt: missedImpressionOrdinal]];
}
