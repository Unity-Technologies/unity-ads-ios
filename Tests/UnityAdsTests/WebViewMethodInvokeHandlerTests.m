...
- (void)testHandleInvocationShouldFailParametersNull {
    ...
    @try {
        [handler handleData: jsonData
             invocationType: @"handleInvocation"];
...
} /* testHandleInvocationShouldFailInvalidSelector */
...
- (void)testHandleInvocationShouldFailInvalidClass {
    ...
    XCTAssertTrue([jsString rangeOfString: @"ERROR"].location != NSNotFound, @"Last JSString should contain 'ERROR'");
    XCTAssertTrue([jsString rangeOfString: @"InvalidInvocationException"].location != NSNotFound, @"Last JSString should contain 'InvalidInvocationException'");
} /* testHandleInvocationShouldFailInvalidClass */
...
- (void)testHandleCallbackShouldFailCallbackNotAdded {
    USRVWebViewMethodInvokeHandler *handler = [[USRVWebViewMethodInvokeHandler alloc] init];
    USRVNativeCallback *nativeCallback = [[USRVNativeCallback alloc] initWithMethod: @"staticTestHandleCallback:"
                                                                      receiverClass: @"UrlProtocolTestsCallbacks"];
...
- (void)testHandleCallbackShouldFailMethodNotStatic {
    USRVWebViewMethodInvokeHandler *handler = [[USRVWebViewMethodInvokeHandler alloc] init];
    USRVNativeCallback *nativeCallback = [[USRVNativeCallback alloc] initWithMethod: @"instanceTestHandleCallback:"
                                                                      receiverClass: @"UrlProtocolTestsCallbacks"];
...
} /* testHandleCallbackShouldSucceed */

- (void)testHandleCallbackWithParamsShouldSucceed {
    USRVWebViewMethodInvokeHandler *handler = [[USRVWebViewMethodInvokeHandler alloc] init];
    USRVNativeCallback *nativeCallback = [[USRVNativeCallback alloc] initWithMethod: @"staticTestHandleCallbackStringParam:"
                                                                      receiverClass: @"UrlProtocolTestsCallbacks"];
...
} /* testHandleCallbackWithParamsShouldSucceed */
