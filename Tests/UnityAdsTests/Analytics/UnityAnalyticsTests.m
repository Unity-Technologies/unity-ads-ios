...
- (void)testOnItemAcquired {
    [UnityAnalytics onItemAcquired: @"transactionId"
                            itemId: @"productId"
                transactionContext: @"transactionContext"
                             level: @"level"
                          itemType: @"itemType"
                            amount: 49.5F
                           balance: 2782787.87237F
...
- (void)testOnItemAcquiredNull {
    [UnityAnalytics onItemAcquired: nil
                            itemId: nil
    ...
    XCTAssertEqualObjects(expected, event);
} /* testOnItemAcquiredNull */

- (void)testOnItemSpent {
    [UnityAnalytics onItemSpent: @"transactionId"
                         itemId: @"productId"
             transactionContext: @"transactionContext"
                          level: @"level"
                       itemType: @"itemType"
...
- (void)testOnItemSpentNull {
    [UnityAnalytics onItemSpent: nil
                         itemId: nil
             transactionContext: nil
                          level: nil
                       itemType: nil
...
- (void)testOnAdComplete {
    [UnityAnalytics onAdComplete: @"myCoolPlacement"
                         network: @"admob"
                        rewarded: YES];
    NSDictionary *expected = @{
        @"type": @"analytics.custom.v1",
...
- (void)testOnAdCompleteNull {
    [UnityAnalytics onAdComplete: nil
                         network: nil
                        rewarded: YES];
    NSDictionary *expected = @{
        @"type": @"analytics.custom.v1",
    ...
    XCTAssertEqualObjects(expected, event);
} /* testOnAdCompleteNull */

- (void)testOnIapTransaction {
    [UnityAnalytics onIapTransaction: @"productId"
                              amount: 45.78F
                            currency: @"USD"
                             isPromo: YES
    ...
    XCTAssertEqualObjects(expected, event);
} /* testOnIapTransaction */

- (void)testOnIapTransactionNull {
    [UnityAnalytics onIapTransaction: nil
                              amount: 45.78F
                            currency: nil
                             isPromo: YES
                             receipt: nil];
