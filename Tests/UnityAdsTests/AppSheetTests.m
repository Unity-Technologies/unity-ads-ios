...
- (void)testPrepare {
    ...
    [appSheet   prepareAppSheet: parameters
        prepareTimeoutInSeconds: 5
...
} /* testPrepareCalledTwiceWithSameId */
...
- (void)testPrepareCalledTwiceWithDifferentIds {
    ...
    [appSheet   prepareAppSheet: parameters2
        prepareTimeoutInSeconds: 5
                completionBlock: ^(BOOL result, NSString *_Nullable error) {
                  XCTAssertEqual(false, result, @"Result should be false");
...
} /* testPrepareCalledTwiceWithDifferentIds */

- (void)testPresentAppSheetNotPrepared {
    NSDictionary *parameters = @{ @"id": @55555555 };

    [appSheet presentAppSheet: parameters
                     animated: true
              completionBlock: ^(BOOL result, NSString *_Nullable error) {
