...
- (void)testWriteAndRead {
    ...
    XCTAssertEqual(true, [storage set: @"tests.value1"
                                value : value1], "Should have been able to set key \"tests.value1\" with value: 12345");
    XCTAssertEqual(true, [storage set: @"tests.value2"
                                value : value2], "Should have been able to set key \"tests.value2\" with value: Testing");
    XCTAssertEqual(true, [storage set: @"tests.value3"
                                value : value3], "Should have been able to set key \"tests.value3\" with value: 12345.12345");
...
- (void)testMultiLevelValue {
    ...
    XCTAssertEqual(false, [storage hasData], "Storage should hold no data in the beginning of the test");
    XCTAssertEqual(true, [storage set: @"level1.level2.level3.level4.level5"
                                value : value1], "Should have been able to set key \"level1.level2.level3.level4.level5\" with value: 12345");
    XCTAssertEqual(true, [storage writeStorage], "Write storage should have succeeded");
...
- (void)testSingleLevelValue {
    ...
    XCTAssertEqual(false, [storage hasData], "Storage should hold no data in the beginning of the test");
    XCTAssertEqual(true, [storage set: @"level1"
                                value : value1], "Should have been able to set key \"level1.level2.level3.level4.level5\" with value: 12345");
    XCTAssertEqual(true, [storage writeStorage], "Write storage should have succeeded");
...
- (void)testGetKeys {
    ...
    [storage set: @"session.DB62D2FF-F4F3-4050-BC22-EE7242638F71.ts"
           value : value];
    [storage set: @"session.DB62D2FF-F4F3-4050-BC22-EE7242638F71.operative.179BBFDA-D3C1-4137-8485-F8ECADE5E605.data"
           value : value];
    ...
    [storage set: @"session.EC71F5DB-D8B8-466B-B878-FEF018298493.ts"
           value : value];
    [storage set: @"session.EC71F5DB-D8B8-466B-B878-FEF018298493.operative.179BBFDA-D3C1-4137-8485-F8ECADE5E605.data"
           value : value];
    ...
    [storage set: @"session.7D2526C4-8123-4068-B481-0EB9680BE974.ts"
           value : value];
    [storage set: @"session.7D2526C4-8123-4068-B481-0EB9680BE974.operative.179BBFDA-D3C1-4137-8485-F8ECADE5E605.data"
           value : value];

    NSArray *keys = [storage getKeys: @"session"
                           recursive : false];
...
- (void)testGetKeysNonRecursive {
    ...
    [storage set: @"session.DB62D2FF-F4F3-4050-BC22-EE7242638F71.operative.179BBFDA-D3C1-4137-8485-F8ECADE5E605.data"
           value : @"heips"];
    [storage set: @"session.DB62D2FF-F4F3-4050-BC22-EE7242638F71.operative.179BBFDA-D3C1-4137-8485-F8ECADE5E605.url"
           value : @"http://moi.com"];
    ...
    [storage set: @"session.EC71F5DB-D8B8-466B-B878-FEF018298493.ts"
           value : value];
    [storage set: @"session.EC71F5DB-D8B8-466B-B878-FEF018298493.operative.179B2FDA-D3C1-4137-8485-F8ECADE5E605.data"
           value : value];
    [storage set: @"session.EC71F5DB-D8B8-466B-B878-FEF018298493.operative.179B2FDA-D3C1-4137-8485-F8ECADE5E605.url"
           value : @"http://moi.com"];
    ...
    [storage set: @"session.7D2526C4-8123-4068-B481-0EB9680BE974.ts"
           value : value];
    [storage set: @"session.7D2526C4-8123-4068-B481-0EB9680BE974.operative.179B4FDA-D3C1-4137-8485-F8ECADE5E605.data"
           value : value];
    [storage set: @"session.7D2526C4-8123-4068-B481-0EB9680BE974.operative.179B4FDA-D3C1-4137-8485-F8ECADE5E605.url"
           value : @"http://moi.com"];
