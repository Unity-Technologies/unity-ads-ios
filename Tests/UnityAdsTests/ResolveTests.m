...
- (void)testBasicResolve {
    ...
    UnityServicesResolveRequestCompletion completion = ^(NSString *host, NSString *address, NSString *error, NSString *errorMessage) {
        returnHost = host;
    ...
    BOOL success = [USRVWebRequestQueue resolve: @"google-public-dns-a.google.com"
