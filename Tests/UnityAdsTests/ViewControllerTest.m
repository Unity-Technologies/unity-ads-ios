...
- (void)testInitWithViews {
    ...
    UADSViewController *adUnitViewController = [[UADSViewController alloc] initWithViews: views
                                                                   supportedOrientations: @(24)
                                                                         statusBarHidden: YES
                                                                        shouldAutorotate: YES
                                                                           isTransparent: NO
                                                                 homeIndicatorAutoHidden: NO];

    [[UIApplication sharedApplication].keyWindow.rootViewController presentViewController: adUnitViewController
                                                                                 animated: NO
                                                                               completion: ^{
                                                                                   [presentExpectation fulfill];
                                                                               }];
    ...
    [adUnitViewController dismissViewControllerAnimated: NO
                                             completion: ^() {
                                                 [dismissExpectation fulfill];
                                             }];
...
- (void)testSetTransform {
    ...
    NSNumber *transform = [(NSNumber *)adUnitViewController.view
    ...
    [adUnitViewController dismissViewControllerAnimated: true
                                             completion: ^() {
                                                 [dismissExpectation fulfill];
                                             }];
...
- (void)testSetViewFrame {
    ...
    [adUnitViewController setViewFrame: @"adunit"
                                     x: 50
                                     y: 60
                                 width: 510
                                height: 520];
    [adUnitViewController setViewFrame: @"videoplayer"
                                     x: 110
                                     y: 120
                                 width: 130
                                height: 140];
    [adUnitViewController setViewFrame: @"webview"
                                     x: 210
                                     y: 220
                                 width: 230
                                height: 240];
...
} /* testSetHomeIndicatorAutoHidden */
