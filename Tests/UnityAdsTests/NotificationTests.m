...
- (void)testReceiveNotification {
    ...
    [USRVNotificationObserver addObserver: @"TestReceiveNotification"
                             userInfoKeys: nil
                             targetObject: nil];

    [[NSNotificationCenter defaultCenter]postNotificationName: @"TestReceiveNotification"
                                                       object: nil];
    ...
    [USRVNotificationObserver removeObserver: @"TestReceiveNotification"
                                targetObject: nil];
}
...
- (void)testReceiveNotificationWithParameters {
    ...
    [USRVNotificationObserver addObserver: @"TestReceiveNotificationWithParameters"
                             userInfoKeys: keyArray
                             targetObject: nil];

    [[NSNotificationCenter defaultCenter]postNotificationName: @"TestReceiveNotificationWithParameters"
                                                       object: nil
                                                     userInfo: userInfo];
    ...
    [USRVNotificationObserver removeObserver: @"TestReceiveNotificationWithParameters"
                                targetObject: nil];
} /* testReceiveNotificationWithParameters */
...
- (void)testReceiveTwoNotifications {
    ...
    [USRVNotificationObserver addObserver: @"TestTwoNotifications1"
                             userInfoKeys: nil
                             targetObject: nil];
    [USRVNotificationObserver addObserver: @"TestTwoNotifications2"
                             userInfoKeys: keyArray
                             targetObject: nil];

    [[NSNotificationCenter defaultCenter]postNotificationName: @"TestTwoNotifications1"
                                                       object: nil];
    [[NSNotificationCenter defaultCenter]postNotificationName: @"TestTwoNotifications2"
                                                       object: nil];
