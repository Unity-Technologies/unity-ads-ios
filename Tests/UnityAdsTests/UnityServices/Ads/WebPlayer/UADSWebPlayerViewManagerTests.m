...
- (void)testAddWebPlayerView {
    ...
    UADSWebPlayerView *firstView = [[UADSWebPlayerView alloc] initWithFrame: CGRectZero
                                                                     viewId: @"firstView"
                                                          webPlayerSettings: nil];

    [manager addWebPlayerView: firstView
                       viewId: @"firstView"];
...
- (void)testMultipleAddWebPlayerView {
    ...
    UADSWebPlayerView *firstView = [[UADSWebPlayerView alloc] initWithFrame: CGRectZero
                                                                     viewId: @"firstView"
                                                          webPlayerSettings: nil];
    UADSWebPlayerView *secondView = [[UADSWebPlayerView alloc] initWithFrame: CGRectZero
                                                                      viewId: @"secondView"
                                                           webPlayerSettings: nil];

    [manager addWebPlayerView: firstView
                       viewId: @"firstView"];
    [manager addWebPlayerView: secondView
                       viewId: @"secondView"];
    UADSWebPlayerView *webPlayerView = [manager getWebPlayerViewWithViewId: @"firstView"];
