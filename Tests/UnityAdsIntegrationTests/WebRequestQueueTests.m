...
- (void)testBasicGetRequest {
    ...
    [USRVWebRequestQueue requestUrl: targetUrl
                               type: @"GET"
                            headers: NULL
                               body: NULL
                      completeBlock: ^(NSString *url, NSError *error, NSString *response, long responseCode, NSDictionary<NSString *, NSString *> *headers) {
