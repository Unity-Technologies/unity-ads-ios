...
- (void)testDownloadFile {
    ...
    [USRVCacheQueue download: [TestUtilities getTestVideoUrl]
                      target: fileName
                     headers: nil
                      append: false];
...
- (void)testResumeDownload {
    ...
    NSDictionary *headers = [NSDictionary dictionaryWithObject: [NSArray arrayWithObject: [NSString stringWithFormat: @"bytes=%llu-", fileSize]]
                                                        forKey: @"Range"];
