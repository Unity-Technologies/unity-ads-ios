...
+(NSData *)dataWithJSONObject:(id)obj options:(NSJSONWritingOptions)opt error:(NSError *_Nullable *)error {
    ...
    if ([NSJSONSerialization isValidJSONObject:obj]) {
        @try {
            NSError *err;
            data = [USRVJsonUtilities _dataWithJSONObject:obj options:opt error:&err];

            if (err) {
                internalError = [[NSError alloc] initWithDomain:USRVJsonUtilitiesErrorDomain code:USRVJsonUtilitiesErrorCodeErrorCaught userInfo:@{
        ...
        @catch (NSException *exception) {
            internalError = [[NSError alloc] initWithDomain:USRVJsonUtilitiesErrorDomain code:USRVJsonUtilitiesErrorCodeExceptionCaught userInfo:@{
        ...
        internalError = [[NSError alloc] initWithDomain:USRVJsonUtilitiesErrorDomain code:USRVJsonUtilitiesErrorCodeInvalidJson userInfo:@{
