...
- (bool)writeToMuteDetectionPath:(NSString *)filePath {
    ...
    @try {
        NSData *muteFileData = [[NSData alloc] initWithBytesNoCopy:MuteSwitchDetection_aiff length:MuteSwitchDetection_aiff_len freeWhenDone:NO];
        [muteFileData writeToFile:filePath atomically:YES];
