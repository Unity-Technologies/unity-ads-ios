...
- (void)testInitWithRequiredJsonData {
    ...
    NSData* jsonData = [NSJSONSerialization dataWithJSONObject:configDictionary options:kNilOptions error:&error];
...
- (void)testToJson {
    ...
    XCTAssertEqualObjects([NSNumber numberWithInteger:[toJsonDictionary count]], [NSNumber numberWithInt:18], "Size of JSON Objects was not as expected");
