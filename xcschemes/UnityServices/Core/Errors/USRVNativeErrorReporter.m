...
+ (void)reportError:(NSString *)errorString {
    ...
    if (webViewApp) {
        [webViewApp sendEvent:NSStringFromUSRVErrorEvent(USRVErrorEventReportNativeError) category:USRVNSStringFromWebViewEventCategory(kUnityServicesWebViewEventCategoryNativeError) params:@[errorString]];
    }
}
